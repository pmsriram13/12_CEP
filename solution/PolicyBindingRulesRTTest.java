...
public class PolicyBindingRulesRTTest {
    ...
    @Test
    public void exceedThresholdTest() throws InterruptedException {
        ...
        if(!sBuilder.toString().isEmpty()){
            ...
            System.out.println("exceedThresholdTest Result:\n " + sBuilder.toString());
    ...
    @Test
    public void withinThresholdTest() throws InterruptedException {
        ...
        if(!sBuilder.toString().isEmpty()) {
            ...
            System.out.println("withinThresholdTest Result:\n " + sBuilder.toString());
